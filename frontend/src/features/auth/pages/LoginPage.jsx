      ...
      <div className="w-full max-w-md">
        <div className="rounded-[28px] border border-graphite/10 bg-white/85 p-8 shadow-[0_18px_40px_rgba(19,20,23,0.12)]">
          <div className="mb-7">
            ...
            <p className="mt-1 text-sm text-ink/70">Entre para acessar seu painel financeiro.</p>
          </div>

          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <label className="block text-sm font-medium text-ink/80 mb-1">Usuario</label>
              <input
                type="text"
                value={username}
